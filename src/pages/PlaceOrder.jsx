      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="w-full text-end mt-8">
             <button onClick={()=> navigate('/orders')} className="bg-black text-white px-16 py-3 txet-sm hover:border hover:border-black hover:bg-white hover:text-black">PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
